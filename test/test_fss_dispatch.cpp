...
void fss() {
    ...
    boost::fibers::fiber f1( boost::fibers::launch_policy::dispatch, fss_fiber);
    boost::fibers::fiber f2( boost::fibers::launch_policy::dispatch, fss_fiber);
    boost::fibers::fiber f3( boost::fibers::launch_policy::dispatch, fss_fiber);
    boost::fibers::fiber f4( boost::fibers::launch_policy::dispatch, fss_fiber);
    boost::fibers::fiber f5( boost::fibers::launch_policy::dispatch, fss_fiber);
    f1.join();
    f2.join();
    f3.join();
    f4.join();
...
void test_fss() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, fss).join();
}
...
void fss_with_custom_cleanup() {
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, fss_fiber_with_custom_cleanup);
    try {
        f.join();
    } catch(...) {
        f.join();
...
void test_fss_with_custom_cleanup() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, fss_with_custom_cleanup).join();
}
...
void do_test_fss_does_no_cleanup_after_release() {
    ...
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, fss_fiber_with_custom_cleanup_and_release);
    try {
        f.join();
    } catch(...) {
        f.join();
...
void do_test_fss_does_no_cleanup_with_null_cleanup_function() {
    ...
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, [&delete_tracker](){
...
void test_fss_does_no_cleanup_after_release() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, do_test_fss_does_no_cleanup_after_release).join();
}

void test_fss_does_no_cleanup_with_null_cleanup_function() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, do_test_fss_does_no_cleanup_with_null_cleanup_function).join();
}
...
void fss_does_not_call_cleanup_after_ptr_destroyed() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, fiber_with_local_fss_ptr).join();
    BOOST_CHECK(!fss_cleanup_called);
}

void test_fss_does_not_call_cleanup_after_ptr_destroyed() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, fss_does_not_call_cleanup_after_ptr_destroyed).join();
}
...
void test_fss_cleanup_not_called_for_null_pointer() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, fss_cleanup_not_called_for_null_pointer).join();
}
...
void test_fss_at_the_same_adress() {
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, fss_at_the_same_adress).join();
}
