...
void fn5() {
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, fn4);
...
void test_join_fn() {
    {
        value1 = 0;
        boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, fn1);
        f.join();
    ...
    }
    {
        value1 = 0;
        value2 = "";
        boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, fn2, 3, "abc");
        f.join();
...
void test_join_memfn() {
    ...
    boost::fibers::fiber( boost::fibers::launch_policy::dispatch, & X::foo, std::ref( x), 3).join();
...
void test_join_copyable() {
    ...
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, cp);
    f.join();
    BOOST_CHECK( cp.state);
    BOOST_CHECK_EQUAL( value1, 3);
}
...
void test_join_moveable() {
    ...
    BOOST_CHECK_EQUAL( value1, 0);
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, std::move( mv) );
    f.join();
    BOOST_CHECK( ! mv.state);
...
void test_join_lambda() {
    {
        ...
        boost::fibers::fiber f(
                boost::fibers::launch_policy::dispatch, [i,abc]() {
                    value1 = i;
                    value2 = abc;
                });
        f.join();
    ...
    }
    {
        ...
        std::string abc("abc");
        boost::fibers::fiber f(
                boost::fibers::launch_policy::dispatch, [](int i, std::string const& abc) {
                    value1 = i;
                    value2 = abc;
                },
                i, abc);
...
void test_join_bind() {
    {
        ...
        std::string abc("abc");
        boost::fibers::fiber f(
            boost::fibers::launch_policy::dispatch, std::bind(
                [i,abc]() {
                    value1 = i;
                    value2 = abc;
                }
...
void test_join_in_fiber() {
    ...
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, fn5);
    BOOST_CHECK( f.joinable() );
...
void test_move_fiber() {
    ...
    boost::fibers::fiber f2( boost::fibers::launch_policy::dispatch, fn1);
...
void test_id() {
    ...
    boost::fibers::fiber f3( boost::fibers::launch_policy::dispatch, fn1);
...
void test_yield() {
    ...
    boost::fibers::fiber f1( boost::fibers::launch_policy::dispatch, fn3, std::ref( v1) );
    boost::fibers::fiber f2( boost::fibers::launch_policy::dispatch, fn3, std::ref( v2) );
    f1.join();
    f2.join();
    BOOST_CHECK( ! f1.joinable() );
    BOOST_CHECK( ! f2.joinable() );
...
void test_detach() {
    {
        boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, (detachable()) );
        BOOST_CHECK( f.joinable() );
        f.detach();
        BOOST_CHECK( ! f.joinable() );
