...
void test_zero_wm_1() {
    bool thrown = false;
    try {
        boost::fibers::bounded_queue< int > c( 0);
...
void test_zero_wm_2() {
    bool thrown = false;
    try {
        boost::fibers::bounded_queue< int > c( 0, 0);
    } catch ( boost::fibers::fiber_error const&) {
        thrown = true;
    }
    BOOST_CHECK( thrown);
...
void test_hwm_less_lwm() {
    bool thrown = false;
    try {
        boost::fibers::bounded_queue< int > c( 2, 3);
    } catch ( boost::fibers::fiber_error const&) {
        thrown = true;
    }
    BOOST_CHECK( thrown);
...
void test_hwm_equal_lwm() {
    bool thrown = false;
    try {
        boost::fibers::bounded_queue< int > c( 3, 3);
    } catch ( boost::fibers::fiber_error const&) {
        thrown = true;
    }
    BOOST_CHECK( thrown);
...
void test_push() {
    boost::fibers::bounded_queue< int > c( 10);
    BOOST_CHECK_EQUAL( c.upper_bound(), 10u );
    BOOST_CHECK_EQUAL( c.lower_bound(), 9u );
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( 1) );
}

void test_push_closed() {
    boost::fibers::bounded_queue< int > c( 10);
    c.close();
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.push( 1) );
}

void test_try_push() {
    boost::fibers::bounded_queue< int > c( 1);
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( 1) );
}

void test_try_push_closed() {
    boost::fibers::bounded_queue< int > c( 1);
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.try_push( 1) );
    c.close();
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.try_push( 2) );
}
...
void test_try_push_full() {
    ...
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.try_push( 1) );
    BOOST_CHECK( boost::fibers::queue_op_status::full == c.try_push( 2) );
}

void test_push_wait_for() {
    boost::fibers::bounded_queue< int > c( 2);
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
}

void test_push_wait_for_closed() {
    boost::fibers::bounded_queue< int > c( 1);
    c.close();
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
}

void test_push_wait_for_timeout() {
    boost::fibers::bounded_queue< int > c( 1);
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
    BOOST_CHECK( boost::fibers::queue_op_status::timeout == c.push_wait_for( 1, std::chrono::seconds( 1) ) );
}

void test_push_wait_until() {
    boost::fibers::bounded_queue< int > c( 2);
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push_wait_until( 1,
...
void test_push_wait_until_closed() {
    boost::fibers::bounded_queue< int > c( 1);
    c.close();
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.push_wait_until( 1,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_push_wait_until_timeout() {
    ...
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push_wait_until( 1,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK( boost::fibers::queue_op_status::timeout == c.push_wait_until( 1,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_pop() {
    boost::fibers::bounded_queue< int > c( 10);
    int v1 = 2, v2 = 0;
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( v1) );
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.pop( v2) );
...
void test_pop_closed() {
    ...
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.pop( v2) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.pop( v2) );
}
...
void test_try_pop() {
    ...
    int v1 = 2, v2 = 0;
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( v1) );
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.try_pop( v2) );
    BOOST_CHECK_EQUAL( v1, v2);
}
...
void test_try_pop_closed() {
    ...
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.try_pop( v2) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.try_pop( v2) );
}
...
void test_try_pop_success() {
    ...
    int v1 = 2, v2 = 0;
    boost::fibers::fiber f1( boost::fibers::launch::post, [&c,&v2](){
        while ( boost::fibers::queue_op_status::success != c.try_pop( v2) );
    });
    boost::fibers::fiber f2( boost::fibers::launch::post, [&c,v1](){
        BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( v1) );
    });
...
void test_pop_wait_for() {
    ...
    int v1 = 2, v2 = 0;
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( v1) );
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.pop_wait_for( v2, std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
}
...
void test_pop_wait_for_closed() {
    ...
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.pop_wait_for( v2, std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.pop_wait_for( v2, std::chrono::seconds( 1) ) );
}
...
void test_pop_wait_for_timeout() {
    ...
    boost::fibers::fiber f( boost::fibers::launch::post, [&c,&v](){
        BOOST_CHECK( boost::fibers::queue_op_status::timeout == c.pop_wait_for( v, std::chrono::seconds( 1) ) );
    });
    f.join();
}
...
void test_pop_wait_until() {
    ...
    int v1 = 2, v2 = 0;
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( v1) );
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.pop_wait_until( v2,
            std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
}
...
void test_pop_wait_until_closed() {
    ...
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.pop_wait_until( v2,
            std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    BOOST_CHECK_EQUAL( v1, v2);
    BOOST_CHECK( boost::fibers::queue_op_status::closed == c.pop_wait_until( v2,
            std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
}
...
void test_pop_wait_until_timeout() {
    ...
    int v = 0;
    boost::fibers::fiber f( boost::fibers::launch::post, [&c,&v](){
        BOOST_CHECK( boost::fibers::queue_op_status::timeout == c.pop_wait_until( v,
                    std::chrono::system_clock::now() + std::chrono::seconds( 1) ) );
    });
    f.join();
}
...
void test_wm_1() {
    boost::fibers::bounded_queue< int > c( 3);
    ...
    boost::fibers::fiber f1( boost::fibers::launch::post, [&c,&ids](){
        ...
        ids.push_back( boost::this_fiber::get_id() );
        BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( 2) );

        ids.push_back( boost::this_fiber::get_id() );
        BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( 3) );

        ids.push_back( boost::this_fiber::get_id() );
        // would be blocked because queue is full
        BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( 4) );

        ids.push_back( boost::this_fiber::get_id() );
        // would be blocked because queue is full
        BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( 5) );
    ...
    boost::fibers::fiber f2( boost::fibers::launch::post, [&c,&ids](){
        ...
        ids.push_back( boost::this_fiber::get_id() );
        // would block because queue is empty
    ...
    BOOST_CHECK_EQUAL( id1, ids[3]); // f1 blocks in push( 4) (queue is full)
    BOOST_CHECK_EQUAL( id2, ids[4]); // f2 resumes and pops 1, f1 gets ready to push 4, f2 yields
    BOOST_CHECK_EQUAL( id1, ids[5]); // f1 resumes and pushes 4, blocks in push( 5) (queue full)
    ...
    BOOST_CHECK_EQUAL( id2, ids[9]); // f2 blocks in pop() (queue is empty)
...
void test_wm_3() {
    boost::fibers::bounded_queue< int > c( 3, 1);
...
void test_wm_4() {
    ...
    BOOST_CHECK_EQUAL( id1, ids[1]); // f1 pushes 2
    BOOST_CHECK_EQUAL( id1, ids[2]); // f1 pushes 3
    BOOST_CHECK_EQUAL( id1, ids[3]); // f1 blocks in push( 4) ( queue full)
    BOOST_CHECK_EQUAL( id2, ids[4]); // f2 resumes and pops 1, f1 gets NOT ready to push 4, f2 yields
    BOOST_CHECK_EQUAL( id2, ids[5]); // f2 pops 2, f1 gets ready to push 4 (lwm == size == 1), f2 yields
...
void test_moveable() {
    boost::fibers::bounded_queue< moveable > c( 10);
    moveable m1( 3), m2;
    BOOST_CHECK( m1.state);
    BOOST_CHECK_EQUAL( 3, m1.value);
    BOOST_CHECK( ! m2.state);
    BOOST_CHECK_EQUAL( -1, m2.value);
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.push( std::move( m1) ) );
    BOOST_CHECK( ! m1.state);
    BOOST_CHECK( ! m2.state);
    BOOST_CHECK( boost::fibers::queue_op_status::success == c.pop( m2) );
    BOOST_CHECK( ! m1.state);
...
boost::unit_test::test_suite * init_unit_test_suite( int, char* []) {
    boost::unit_test::test_suite * test =
        BOOST_TEST_SUITE("Boost.Fiber: bounded_queue test suite");
