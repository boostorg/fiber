...
void test_pop_success() {
    boost::fibers::bounded_channel< int > c( 10);
    int v1 = 2, v2 = 0;
    boost::fibers::fiber f1( boost::fibers::launch_policy::dispatch, [&c,&v2](){
        BOOST_CHECK( boost::fibers::channel_op_status::success == c.pop( v2) );
    });
    boost::fibers::fiber f2( boost::fibers::launch_policy::dispatch, [&c,v1](){
        BOOST_CHECK( boost::fibers::channel_op_status::success == c.push( v1) );
    });
    f1.join();
    f2.join();
...
void test_pop_wait_for_timeout() {
    boost::fibers::bounded_channel< int > c( 10);
    int v = 0;
    boost::fibers::fiber f( boost::fibers::launch_policy::dispatch, [&c,&v](){
...
void test_wm_1() {
    ...
    boost::fibers::fiber f1( boost::fibers::launch_policy::dispatch, [&c,&ids](){
    ...
    boost::fibers::fiber f2( boost::fibers::launch_policy::dispatch, [&c,&ids](){
        ids.push_back( boost::this_fiber::get_id() );
