...
void fn_1( boost::tasklets::barrier & b)
{
	++value1;
...
void fn_2( boost::tasklets::barrier & b)
{
	++value2;
	boost::this_tasklet::yield();
	++value2;
...
void test_case_1()
{
	...
	boost::tasklets::barrier b( 2);
	sched.submit_tasklet(
		boost::tasklet(
			fn_1, boost::ref( b), boost::tasklet::default_stacksize, boost::protected_stack_allocator()) );
	sched.submit_tasklet(
		boost::tasklet(
			fn_2, boost::ref( b), boost::tasklet::default_stacksize, boost::protected_stack_allocator()) );
...
boost::unit_test::test_suite * init_unit_test_suite( int, char* [])
{
	boost::unit_test::test_suite * test =
		BOOST_TEST_SUITE("Boost.Tasklet: barrier test suite");
