...
void wait_fn( boost::tasklets::manual_reset_event & ev)
{
	ev.wait();
	++value;
}
...
void test_case_1()
{
	...
	boost::tasklets::manual_reset_event ev;
...
void test_case_3()
{
	value = 0;
	boost::tasklets::scheduler<> sched;
	boost::tasklets::manual_reset_event ev( true);
...
boost::unit_test::test_suite * init_unit_test_suite( int, char* [])
{
	boost::unit_test::test_suite * test =
		BOOST_TEST_SUITE("Boost.Tasklet: manual-reset-event test suite");
